...
.factory('Match', function($http, $q) {
    ...
    return {
        all: function(skip, limit) {
            var url = 'http://localhost:8070/match/getMatchCollectionRefresh?skip=' + skip + '&limit=' + limit;
        ...
        remove: function(match) {
            match.splice(match.indexOf(match), 1);
        },

        get: function(matchId) {

            var url = 'http://localhost:8070/match/getMatchDetail?matchId=' + matchId;
